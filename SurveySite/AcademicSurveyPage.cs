...
{
    public partial class AcademicSurveyPage : Form
    {
        private bool isEditMode;
        private AcademicQueryPage _academicQueryPage;
        private readonly SurveySiteEntities _db;
        public AcademicSurveyPage(AcademicQueryPage academic_Query_Page = null)
        {
            InitializeComponent();
            lblTitle.Text = "Academic Survey";
            isEditMode = false;
            _db = new SurveySiteEntities();
            _academicQueryPage = academic_Query_Page;
            loadBoxes();
        }

        public AcademicSurveyPage(AcademicSurvey entryToEdit, AcademicQueryPage academic_Query_Page = null)
        {
            InitializeComponent();
        ...
        private void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Hide();
                var queryPage = new AcademicQueryPage();
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isEditMode)
                {
                    ...
                    var entry = _db.AcademicSurveys.FirstOrDefault(x => x.id == id);
                ...
                else
                {
                    ...
                    _db.AcademicSurveys.Add(survey);
                    MessageBox.Show("Thank you for completing the Academic Survey!");
        ...
        private void PopulateFields(AcademicSurvey entry)
        {
