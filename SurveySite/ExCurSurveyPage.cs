...
{
    public partial class ExCurSurveyPage : Form
    {
        private bool isEditMode;
        private ExCurQueryPage _exCurQueryPage;
        private readonly SurveySiteEntities _db;
        public ExCurSurveyPage(ExCurQueryPage exCur_Query_Page = null)
        {
            InitializeComponent();
            lblTitle.Text = "Extracurricular Survey";
            isEditMode = false;
            _db = new SurveySiteEntities();
            _exCurQueryPage = exCur_Query_Page;
            loadBoxes();
        }

        public ExCurSurveyPage(ExCurSurvey entryToEdit, ExCurQueryPage exCur_Query_Page = null)
        {
            InitializeComponent();
        ...
        private void btnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Hide();
                var queryPage = new ExCurQueryPage();
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isEditMode)
                {
                    ...
                    var entry = _db.ExCurSurveys.FirstOrDefault(x => x.id == id);
                ...
                else
                {
                    ...
                    _db.ExCurSurveys.Add(survey);
                    MessageBox.Show("Thank you for completing the Extracurricular Survey!");
                }
                _db.SaveChanges();
        ...
        private void PopulateFields(ExCurSurvey entry)
        {
